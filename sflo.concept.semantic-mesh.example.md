...
desc: ''
updated: 1751984996304
created: 1750640592487
---

```file
/test-ns/                                        # namespace node
├── _node-meta/                                       # node component (metadata)
...
├── _node-ref/                                        # node component (reference data)
│   ├── _current/                                # component layer
...
├── _node-data/                                       # node component (data)
│   ├── _current/                                # component layer
...
│   │   └── index.html                           # resource page
│   └── index.html                               # resource page
├── _node-ref/                                        # node component (reference data) - OPTIONAL
│   ├── _current/                                # component layer
