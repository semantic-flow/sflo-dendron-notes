...
- **Versioned**: Changes are tracked and managed through the [[weave|sflo.concept.weave]] process
...
##### System Elements
System elements are generated by [[weave|sflo.concept.weave]]:
...
- **[[V-series dataset series|sflo.concept.mesh.resource.element.v-series-dataset-series]]**: System-managed collections of version datasets that track the historical series of checkpoints for versioned datasets
...
- Resource pages (index.html) should be present in every mesh folder after [[weaving|sflo.concept.weave]]
...
- [[V-series dataset series|sflo.concept.mesh.resource.element.v-series-dataset-series]] manage the historical checkpoints and prevent infinite recursion in versioning
...
### Weave Process
The [[weave|sflo.concept.weave]] process maintains mesh integrity by:
